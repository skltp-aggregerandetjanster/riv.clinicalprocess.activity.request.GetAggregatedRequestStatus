...
public class GetAggregatedRequestStatusMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedRequestStatus";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedRequestStatusMuleServer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        //         Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file "src/main/app/GetAggregatedRequestStatus-common.xml"
        //
