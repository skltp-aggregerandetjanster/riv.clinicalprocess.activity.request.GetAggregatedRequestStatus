...
public class GetAggregatedRequestStatusTeststubMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedRequestStatus-teststub";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedRequestStatusTeststubMuleServer.class);
